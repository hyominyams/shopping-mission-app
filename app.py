...
missions = OrderedDict({
    "우리 가족을 위한 카레라이스 만들기 🍛 [30,000원]": {
        "budget": 30_000,
        "desc": "<div style='font-size:17px;'>우리 가족이 배부르게 먹을 수 있는 양의 카레라이스를 만들어봅시다! <strong>[4명]</strong> 기준입니다.</div>"
    },
    "여름 캠핑 준비하기 🏕️ [40,000원]": {
        "budget": 40_000,
        "desc": "<div style='font-size:17px;'>가족과 함께 1박 2일로 캠핑을 떠납니다! 꼭 필요한 물건을 준비해보세요. <strong>[4명]</strong> 기준입니다.</div>"
    },
    "친구 생일 파티 준비하기 🎉 [40,000원]": {
        "budget": 40_000,
        "desc": "<div style='font-size:17px;'>친구의 생일을 축하하고, 파티를 즐기기 위한 준비를 해봅시다. <strong>[4명]</strong> 기준입니다.</div>"
    }
})
